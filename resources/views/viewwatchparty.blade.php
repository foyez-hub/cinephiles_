...
<div style="width: 55%; height: auto; margin-top: 200px; margin-left: 50px; position: relative;">
    <div id="videofile">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    html += `
<div style="border: 3px solid #4dbf00;"  class="conta11">
    <img style="border: 2px solid #4dbf00;" src="images/` + value.chatimg + `" alt="Avatar" class="right" />
   ...
   setInterval(loadWatchParty,1000);
