...
<section style="margin-top: 200px;">
    <h1 style="color: white;" id="moviesname" class="movieScroolHeader mt-2">Movies</h1>
...
<section>
    ...
    <h1 style="color:aliceblue" id="peoples" class="movieScroolHeader mt-2">Peoples</h1>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data[0], function(key, value) {
                    html +=
                        '<div style="border: 5px solid #4dbf00;"  class="items" id="carousel-items">' +
                        '<div  class="item">' +
                ...
                document.getElementById("moviesname").style.display='none';
